##Code for  wavelet plots for Pepi, Holyoak & Karban 2021, Ecology Letters
rm(list=ls())
library(biwavelet)

setwd("~/Documents/Research/dissertation/time series analyses/eco lett final materials")
